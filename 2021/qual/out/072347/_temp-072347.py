    ...
    for intersection in intersections:
        ...
        for street in intersection.streets_in:
            if streets_popularity[street.name] > 0 or intersection_popularity[intersection.id] > 0:
                ...
                constant = 2 if D < 10 else 2000
                print(intersection_popularity[intersection.id])
                ...
                duration = (1 * ((streets_popularity[street.name]) / intersection_popularity[intersection.id])) * (D // constant)
                if duration < 1:
                    duration = 1
                if duration > D:
                    duration = D
