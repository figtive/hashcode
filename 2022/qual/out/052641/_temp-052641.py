...
def main():
            ...
            if project.start_day < 0:
                for required_skill in project.skills:
                    for _, contributor in contributors.items():
                        ...
                        if contributor.current_project is None or contributor.current_project.start_day + contributor.current_project.duration > T:
                            log(contributor)
    ...
    for project in project_selected:
        ...
        if project.start_day >= 0:
            print(project.name)
            print(" ".join([c.name for c in project.contributors]))
